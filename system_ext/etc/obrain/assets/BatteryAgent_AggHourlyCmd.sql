...
select
    ...
    {val_end_ts} as 'end_ts',
    {val_wall_start_ts} as 'timestamp',
    cnt_5min, cnt_30min, cnt_60min, cnt_120min, energy_120min, duration_120min, cnt_300min, energy_300min, duration_300min, cnt_gt_300min, energy_gt_300min, duration_gt_300min
from cnt;